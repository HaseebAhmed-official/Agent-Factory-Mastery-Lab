...
|-----------|----------|---------------|
| `Curriculum/` | Full lesson-by-lesson maps for all 6 chapters | Student asks about a specific lesson, chapter, or curriculum navigation |
...
| `Vocabulary/` | Master glossary (10 categories) + vocabulary handling protocol | Defining terms, first use of acronyms, student asks "what does X mean?" |
...
### Curriculum/
- `chapter-1-paradigm.md` -- Ch.1: AI Agent Factory Paradigm (10 lessons)
- `chapter-2-markdown.md` -- Ch.2: Markdown Writing Instructions (5 lessons)
- `chapter-3-claude-code.md` -- Ch.3: General Agents - Claude Code & Cowork (32 lessons, 6 modules)
- `chapter-4-context-engineering.md` -- Ch.4: Effective Context Engineering (10 lessons)
- `chapter-5-sdd.md` -- Ch.5: Spec-Driven Development (10 lessons)
- `chapter-6-seven-principles.md` -- Ch.6: Seven Principles of General Agent Problem Solving (11 lessons)
...
### Vocabulary/
- `master-glossary.md` -- All 10 vocabulary category lists
...
### Frameworks/
- `anti-patterns.md` -- Nine named anti-patterns with descriptions and source chapters
- `edge-case-protocol.md` -- "What Goes Wrong" four-axis framework
- `cross-chapter-map.md` -- Full inter-chapter connection diagram + LLM constraint responses
